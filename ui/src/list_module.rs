use contracts::{Prompt, Tab, Storage, Result, PromptFilter};
use std::sync::Arc;
...
impl ListModule {
    ...
    pub async fn update(&mut self, msg: crate::types::AppMessage, ctx: &mut crate::types::UpdateContext<'_>) -> Result<Option<crate::types::AppMessage>> {
        ...
        match msg {
            AppMessage::NextTab | AppMessage::PrevTab | AppMessage::SetTab(_) => self.handle_navigation(msg, ctx).await,
            AppMessage::Undo | AppMessage::Redo => self.handle_history(msg, ctx).await,
            AppMessage::MoveDown | AppMessage::MoveUp | AppMessage::MoveToTop | AppMessage::MoveToBottom => {
    ...
    async fn handle_navigation(&mut self, msg: crate::types::AppMessage, ctx: &crate::types::UpdateContext<'_>) -> Result<Option<crate::types::AppMessage>> {
        use crate::types::AppMessage;
        match msg {
    ...
    async fn handle_history(&mut self, msg: crate::types::AppMessage, ctx: &crate::types::UpdateContext<'_>) -> Result<Option<crate::types::AppMessage>> {
        use crate::types::AppMessage;
        match msg {
            AppMessage::Undo => {
    ...
    fn handle_movement(&mut self, msg: &crate::types::AppMessage, ctx: &crate::types::UpdateContext<'_>) {
        use crate::types::AppMessage;
        match msg {
    ...
    async fn handle_item_ops(&mut self, msg: crate::types::AppMessage, ctx: &mut crate::types::UpdateContext<'_>) -> Result<Option<crate::types::AppMessage>> {
        use crate::types::AppMessage;
        match msg {
            ...
            AppMessage::MoveItemDown if !self.prompts.is_empty() && self.selected_index < self.prompts.len() - 1 => {
                self.history.push(self.active_tab, self.prompts.clone());
                self.prompts.swap(self.selected_index, self.selected_index + 1);
                self.selected_index += 1;
                self.save_current_list(ctx.storage).await?;
    ...
    async fn stage_selected(&mut self, ctx: &crate::types::UpdateContext<'_>) -> Result<Option<crate::types::AppMessage>> {
        use crate::types::AppMessage;
    ...
    async fn archive_selected(&mut self, ctx: &mut crate::types::UpdateContext<'_>) -> Result<Option<crate::types::AppMessage>> {
        use crate::types::AppMessage;
        if self.active_tab == Tab::Settings {
            let tabs_len = Tab::settings_display_len();
    ...
    async fn duplicate_selected(&mut self, ctx: &crate::types::UpdateContext<'_>) -> Result<Option<crate::types::AppMessage>> {
        use crate::types::AppMessage;
        if self.active_tab == Tab::Settings || self.prompts.is_empty() {
            return Ok(None);
        }
    ...
    async fn restore_selected(&mut self, ctx: &crate::types::UpdateContext<'_>) -> Result<Option<crate::types::AppMessage>> {
        use crate::types::AppMessage;
    ...
    async fn handle_settings_ops(&mut self, msg: crate::types::AppMessage, ctx: &mut crate::types::UpdateContext<'_>) -> Result<Option<crate::types::AppMessage>> {
        use crate::types::AppMessage;
        match msg {
            ...
            AppMessage::ToggleBranchFilter => {
                ...
                self.load_prompts(ctx.storage).await?;
                Ok(Some(AppMessage::Notify(format!("Branch filter: {}", if self.branch_filter { "ON" } else { "OFF" }), ratatui_toaster::ToastType::Info)))
            }
            AppMessage::ToggleFolderFilter => {
                self.folder_filter = !self.folder_filter;
                self.load_prompts(ctx.storage).await?;
                Ok(Some(AppMessage::Notify(format!("Folder filter: {}", if self.folder_filter { "ON" } else { "OFF" }), ratatui_toaster::ToastType::Info)))
            }
            AppMessage::ToggleProjectFilter => {
                self.project_filter = !self.project_filter;
                self.load_prompts(ctx.storage).await?;
                Ok(Some(AppMessage::Notify(format!("Project filter: {}", if self.project_filter { "ON" } else { "OFF" }), ratatui_toaster::ToastType::Info)))
            }
    ...
    async fn toggle_setting(&self, ctx: &mut crate::types::UpdateContext<'_>) -> Result<Option<crate::types::AppMessage>> {
        use crate::types::AppMessage;
        if self.active_tab != Tab::Settings { return Ok(None); }
    ...
    async fn handle_project_ops(&mut self, msg: crate::types::AppMessage, ctx: &crate::types::UpdateContext<'_>) -> Result<Option<crate::types::AppMessage>> {
        use crate::types::AppMessage;
        match msg {
            AppMessage::SelectProject => {
                ...
                let pos = id_to_match.and_then(|id| self.projects_manager.projects.iter().position(|p| p.id == id)).map_or(0, |p| p + 1);
            ...
            AppMessage::SetProject(id) => {
                ...
                self.load_prompts(ctx.storage).await?;
                let name = id.and_then(|id| self.projects_manager.projects.iter().find(|p| p.id == id)).map_or_else(|| "Default".into(), |p| p.title.clone());
    ...
    fn handle_project_picker_input(&mut self, key: crossterm::event::KeyEvent) -> Option<crate::types::AppMessage> {
        use crate::types::AppMessage;
        use crossterm::event::KeyCode;
        match key.code {
    ...
    async fn handle_search_ops(&mut self, msg: crate::types::AppMessage, ctx: &crate::types::UpdateContext<'_>) -> Result<Option<crate::types::AppMessage>> {
        use crate::types::AppMessage;
        match msg {
            AppMessage::Search(query) => { self.search_query = query; self.load_prompts(ctx.storage).await?; }
            AppMessage::Paste(content) => { self.search_query.push_str(&content.replace(['\n', '\r'], "")); self.load_prompts(ctx.storage).await?; }
    ...
    async fn handle_search_input(&mut self, key: crossterm::event::KeyEvent, ctx: &crate::types::UpdateContext<'_>) -> Result<()> {
    ...
    async fn handle_theme_picker_input(&mut self, key: &crossterm::event::KeyEvent, ctx: &mut crate::types::UpdateContext<'_>) -> Result<Option<crate::types::AppMessage>> {
        ...
        match key.code {
            KeyCode::Esc => { ctx.settings.theme_name = self.original_theme.take(); }
            KeyCode::Char('j') | KeyCode::Down => {
