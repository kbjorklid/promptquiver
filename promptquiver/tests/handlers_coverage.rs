...
async fn test_navigation_keys() {
    ...
    for text in ["P1", "P2", "P3"] {
        storage
            .save_prompt(contracts::Prompt::new(
                text.to_string(),
...
async fn test_move_item_handlers() {
    ...
    p1.order_index = 0;
    let mut p2 = contracts::Prompt::new(
        "P2".to_string(),
        contracts::PromptType::Prompt,
        Some(common::TEST_PATH.to_string()),
        None,
...
async fn test_app_handle_message_transitions() {
    ...
    app.mode = promptquiver::app::Mode::ProjectPicker;
    app.handle_message(ui::AppMessage::ProjectPickerInput(crossterm::event::KeyEvent::new(
        crossterm::event::KeyCode::Esc,
        crossterm::event::KeyModifiers::NONE,
    )))
    .await
    ...
    app.handle_message(ui::AppMessage::SearchInput(crossterm::event::KeyEvent::new(
...
async fn test_app_handle_message_global_handlers() {
    ...
    // Test Notify
    app.handle_message(ui::AppMessage::Notify(
        "Hello".to_string(),
...
async fn test_coverage_boost_list_module_extra() {
    ...
    storage
        .save_prompts(vec![contracts::Prompt::new(
            "note".into(),
    ...
    let mut arch_prompt = contracts::Prompt::new(
        "archived".into(),
        contracts::PromptType::Prompt,
        Some(common::TEST_PATH.to_string()),
        None,
